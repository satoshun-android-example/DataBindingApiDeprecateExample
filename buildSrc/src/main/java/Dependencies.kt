...
object Libs {
  ...
  private const val vmoshi = "1.8.0"
  const val moshi = "com.squareup.moshi:moshi:$vmoshi"
  const val moshi_kt = "com.squareup.moshi:moshi-kotlin:$vmoshi"
  const val moshi_codegen = "com.squareup.moshi:moshi-kotlin-codegen:$vmoshi"
  const val retrofit_moshi = "com.squareup.retrofit2:converter-moshi:2.4.0"
